      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md text-center hover:shadow-xl transition flex flex-col items-center">
              <FaStar className="text-yellow-400 text-4xl sm:text-5xl mb-4" />
              <h3 className="font-semibold text-lg sm:text-xl mb-2">Quality Products</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md text-center hover:shadow-xl transition flex flex-col items-center">
              <FaShippingFast className="text-yellow-400 text-4xl sm:text-5xl mb-4" />
              <h3 className="font-semibold text-lg sm:text-xl mb-2">Fast Delivery</h3>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md text-center hover:shadow-xl transition flex flex-col items-center">
              <FaHeadset className="text-yellow-400 text-4xl sm:text-5xl mb-4" />
              <h3 className="font-semibold text-lg sm:text-xl mb-2">Customer Support</h3>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
